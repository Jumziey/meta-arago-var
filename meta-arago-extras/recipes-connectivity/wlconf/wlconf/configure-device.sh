...
if [ ! $# -eq 1 ]; then
   echo "must pass a device name: wl1801, wl1805, wl1807, wl1831, wl1835 or wl1837"
   exit
fi
...
if [ $# -eq 1 ]; then
  case $1 in
    wl1801) number_2_4G_antenna=1; number_5G_antenna=0;ht40=2;low_band_component=0xFF
      ;;
    wl1805) number_2_4G_antenna=1; number_5G_antenna=0;ht40=2;low_band_component=0xFF
      ;;
    wl1807) number_2_4G_antenna=2; number_5G_antenna=1;ht40=2;low_band_component=0xFF
      ;;
    wl1831) number_2_4G_antenna=2; number_5G_antenna=0;ht40=0;low_band_component=0x02
      ;;
    wl1835) number_2_4G_antenna=2; number_5G_antenna=0;ht40=0;low_band_component=0x02
      ;;
    wl1837) number_2_4G_antenna=2; number_5G_antenna=1;ht40=0;low_band_component=0x02
      ;;
   *) echo "Unknown device";exit ;;
  esac
fi

# For all MODULE devices  board_type is 4
board_type=4
